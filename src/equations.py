...
for i in range(n):
    ...
    forces.append((Pi, -m[i + 1] * g * I.y - 0.001* u[i + 1] * Bi.y))# Set the force applied at the point
    forces.append((points[-2],   0.001* u[i + 1] * Bi.y))# Set the force applied at the point
